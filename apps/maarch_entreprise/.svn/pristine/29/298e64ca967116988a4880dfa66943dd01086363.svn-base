...
require_once 'apps/maarch_entreprise/tools/PEAR/HTTP/Request.php';
...
class SOAP_WSDL_Cache extends SOAP_Base
{
                             ...
                             $cacheDir = null)
    {
        ...
        $SOAP_Base = new SOAP_Base('WSDLCACHE');
...
class SOAP_WSDL_Parser extends SOAP_Base
{
    ...
    public function __construct($uri, &$wsdl, $docs = false)
    {
        ...
        $SOAP_Base = new SOAP_Base('WSDLPARSER');
...
class SOAP_WSDL_ObjectParser extends SOAP_Base
{
    ...
    {
        //echo '<br/>------------juste avant----------<br/>';
        $SOAP_Base = new SOAP_Base('WSDLOBJECTPARSER');
